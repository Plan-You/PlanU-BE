...
public class AvailableDateController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> saveAvailableDates(@RequestBody AvailableDatesRequest availableDatesDto,
                                                           @AuthenticationPrincipal CustomUserDetails userDetails) {
        availableDatesService.createAvailableDates(userDetails.getId(), availableDatesDto);
        return BaseResponse.toResponseEntity(HttpStatus.CREATED, "가능한 날짜 등록 성공");
    }
